...
var study_cat = document.getElementsByClassName("study-cat");
...
function faqValidation() {
  ...
  if (
    qstncategory[0].checked == false ||
    qstncategory[1].checked == false ||
    qstncategory[2].checked == false
  ) {
