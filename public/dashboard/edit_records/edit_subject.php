    ...
    <?php 
            ...
            ?>
                <div class="alert alert-primary" role="alert">
                    <?php  echo "successfully updated " . $subject .".!";?>
                    <!-- <?php header('locaton:../add_records/add_subject.php');?> -->
                </div>
            <?php 
                }else{
                ...
                <table class="bg-light table">
                        ...
                        // echo $query_results;
                            ...
                            <tr>
                                ...
                                <td><a href="<?php base_url()?>dashboard/edit_record/edit_subject.php?id=<?php $row['subject_id']?>">Edit</a><?php ?></td>
                            </tr>
                            <?php 
                            }
                            ?>
