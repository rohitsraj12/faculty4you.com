...
<head>
    ...
    <title>Log in - student | faculty4you.com | Academic - Non academic | Online - Offline Training</title>
...
<body>
    ...
    <div class="body-wrap">
                                    ...
                                    <div class="wrap-container">
                                        <nav>
                                            <ul>
                                                ...
                                                <li class="nav__list"><a href="<?php base_url();?>student/login.php" class="nav__link nav-active">Student login</a></li>
                                            </ul>
                                        </nav>
        ...
        <div class="student-login-container body-container">
            <div class="section-member wrap-container">
                <?php
                        if(!empty($_GET['register'])){
                        $message = "Congratulations, Your account has been successfully created. Login now and create your profile and post your requirement/s";
                        ?>
