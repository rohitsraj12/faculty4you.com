...
if(isset($_POST['submit_login'])){
    ...
    if(empty($mail_user_name) || empty($password)){
        ...
        header("Location: ../../../public/dashboard/log_in.php?error=emptyfields");
        exit();
    } else {
        ...
        if(!mysqli_stmt_prepare($stmt, $sql)){
            header("Location: ../../../public/dashboard/log_in.php?error=sqlerror");
            exit();
        } else {
            ...
            if($row = mysqli_fetch_assoc($result)){
                ...
                if($password_check == false) {
                    ...
                    header("Location: ../../../public/dashboard/log_in.php?error=wrongPassword");
                    exit();
                ...
                header("Location: ../../../public/dashboard/log_in.php?error=nouser");
                exit();
            }
        }
    }
